window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function injectCardCss() {
      ...
      if (document.getElementById("dsh-permguard-settings-card-style") !== null) return;
      const tag = document.createElement("style");
      tag.id = "dsh-permguard-settings-card-style";
    ...
    function apply(ctx) {
      ...
      const ROW_CONFIG_KEY = "dsh-perm-guard#perm-guard";
      slots.inject("plugins.row.config", () => slots.register(
        { name: "plugins.row.config", key: ROW_CONFIG_KEY, order: 30, label: "Auto 权限" },
        () => react.createElement(SettingsPanel, { inCard: true }),
      ));
      ...
      slots.inject("plugins.bundle.config", () => slots.register(
        { name: "plugins.bundle.config", key: "dsh-perm-guard", order: 30, label: "Auto 权限" },
        () => react.createElement(SettingsPanel, { inCard: true }),
      ));
