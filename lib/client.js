  ...
  factory: (require) => {
    ...
    function AutoButton() {
      ...
      return react.createElement("button", {
        ...
        onClick: toggle,
        title: "Auto 自动审批：" + (on ? "开启中——信任目录内自动放行，危险操作弹窗确认" : "关闭——恢复宿主默认审批")
      }, on ? "Auto ✓" : "Auto");
    }
      ...
      return react.createElement("div", { className: "pg-panel" }, [
        react.createElement("div", { className: "pg-row" }, [
          react.createElement("div", null, [
            ...
            react.createElement("div", { className: "pg-row-sub" }, "信任目录内自动放行，危险操作弹窗确认；关闭后恢复宿主默认审批")
          ]),
